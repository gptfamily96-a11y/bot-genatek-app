...
• تتتعرف على قدرة بشرتك على إنتاج الكولاجين ومستويات الترطيب الطبيعي
...
• تفهم تحمّل بشرتك للإجهاد التأكسدي والالتهابات
• وعلاقته بالحساسية والمشاكل الجلدية المتكررة
• تفهم كيف يستخدم جسمك الإنزيم Q10 لإصلاح البشرة وتعزيز حيويتها
• واحتياجاتك من السيلينيوم لصحة البشرة المثلى
• منتجات مخصّصة للعناية بالبشرة (سيروم، لوشن) ومكمّلات غذائية ملائمة لاحتياجاتك
• إزالة السموم – المرحلة الأولى: تعرف على قدرة جسمك على التخلّص من المركبات
الهيدروكربونية العطرية متعددة الحلقات (PAHs) الموجودة في الدخان والسخام
• إزالة السموم – المرحلة الثانية: تعرف على قدرة جسمك على تحييد السموم مثل
المبيدات، المواد الكيميائية، والمعادن الثقيلة (الزئبق – الرصاص – الكادميوم)
...
• خليط المغذيات الدقيقة المخصّص:
تعرف على Complete NutriMe، وهو مزيج غذائي مصمّم وراثيًا لتحسين الامتصاص
ودعم صحتك على المدى الطويل`,
      packageSubMenu
    );
    return;
  }
...
• تتتعاني من آلام بطن، انتفاخ، أو اضطرابات هضمية متكررة.

...
• خليط المغذيات الدقيقة المخصّص: Complete NutriMe`
);

await sendList(to, ``, packageSubMenu);
...
• استجابة مضادات الاكتئاب
• توصيات مخصصة لتحسين صحتك الذهنية`,
packageSubMenu
);
...
*وش تقدم لك الباقة؟*
• تحدد مسببات الحساسية بدقة فائقة من خلال اختبار واحد شامل
• قائمة بأكثر من 300 مادة مسببة للحساسية
• تصميم خطة علاج فعالة
• إجراءات وقائية
• تعديل النظام الغذائي أو اختيار منتجات مناسبة`,
packageSubMenu
);
...
• آلام بطن، انتفاخ، اضطرابات متكررة
• إرهاق أو صداع بعد الأكل
• تجارب بدون راحة حقيقية

*وش تقدم لك الباقة؟*
• تحليل استجابة الجسم لأكثر من 300 مكوّن
• تشخيص دقيق
• نظام غذائي مريح
• إرشادات علاجية
• مكملات مناسبة`,
